...
smd({
  ...
  try {
    ...
    return await _0x2a10d6.send(!_0x4e5e2e ? "There's no plugin install in " + Config.botname + "." : !_0x2420b0 ? "All Installed Modules are:-\n\n" + _0x4e5e2e : _0x4e5e2e);
  } catch (_0x21e335) {
...
smd({
  ...
  if (!_0x40e763) {
    return await _0x1510c9.reply("hii kindly, Provide Me Plugin Name");
  }
  if (_0x40e763 === "alls") {
...
smd({
  ...
  if (!_0x2b0828.toLowerCase().includes("https")) {
    return await _0xf71b5c.send("hii kindly, Provide Me Plugin Url");
  }
