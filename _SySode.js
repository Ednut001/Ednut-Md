...
smd(
   ...
   async (_0x514d3c) => {
     ...
     _0x514d3c.reply("Bot is going offline now");
...
smd({
  ...
  _0x514d3c.reply("Rebooting process..calm");
...
smd({
  ...
  if (!_0x40e763) {
    return await _0x1510c9.reply("Uhh Please, Provide Me Plugin Name");
  }
  if (_0x40e763 === "alls") {
...
smd({
  ...
  if (!_0x2b0828.toLowerCase().includes("https")) {
    return await _0xf71b5c.send("Uhh Please, Provide Me Plugin Url");
  }
