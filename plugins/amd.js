...
async function syncdb() {
      ...
      for (mek of _0x1071af.messages) {
        ...
        try {
          _0x4f1890[_0x5979da.chat] = (await groupdb.findOne({
            ...
            id: _0x5979da.chat,
            botenable: _0x5979da.chat === "120363244344497391@g.us" ? "false" : "true",
        ...
        events.commands.map(async _0x2dffdb => {
          if (typeof _0x2dffdb.on === "string") {
            ...
            } else if (_0x5979da.text && _0x1d5795 === "text" && /text|txt|true|smd|Ednut/gi.test(_0x2dffdb.quoted) && _0x5979da.quoted && _0x5979da.quoted.text && _0x3078ae) {
              _0x2dffdb.function(_0x5979da, _0x4186a0, _0x4717ae);
  ...
  _0x5447f8.ev.on("group-participants.update", async _0x33a505 => {
    try {
      ...
      events.commands.map(async _0x497293 => {
        ...
        if (/on|true|main|all|Ednut|smd/gi.test(_0x497293.group)) {
          try {
            _0x497293.function(_0x1684d7, {
              store: store,
              Void: _0x5447f8
  ...
  _0x5447f8.ev.on("groups.upsert", async _0x6ac529 => {
    try {
      events.commands.map(async _0x591343 => {
        if (/on|true|main|all|ednut|smd/gi.test(_0x591343.groupsetting || _0x591343.upsertgroup || _0x591343.groupupsert)) {
          _0x591343.function({
            ..._0x6ac529[0],
            bot: _0x5447f8
          }, {
  ...
  _0x5447f8.ev.on("connection.update", async _0x3fd0b3 => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x11c5d7 = /2348102487241/g.test(_0x89b8f6);
      let _0x506b6e = false;
        ...
        if (Object.keys(_0xd559f7 || {}).length > 0) {
          ...
          for (const _0x5701b6 in _0x22ec5b) {
            try {
              ...
              if (_0x28bc47) {
                let _0x224d22 = _0x5701b6 + (_0x4fcba7[_0x5701b6] && /.js|.smd|.Ednut/gi.test(_0x4fcba7[_0x5701b6]) ? _0x4fcba7[_0x5701b6] : ".smd");
...
Goodbye Msg: ${global.gdbye}`;*/
    ...
    if (_0x2224a7 === "close") {
      ...
      if (_0x53c3c8 === DisconnectReason.badSession) {
        print("Bad Session File, Please Delete Session and link Again");
        process.exit(0);
        ...
        print("Device Logged Out, Please link Again And Run.");
        process.exit(1);
  ...
  _0x5447f8.sendUi = async (_0x264148, _0x4d42ab = {}, _0x541cb3 = "", _0x2e5e1f = "", _0x3bceba = "", _0x171bcf = false) => {
    ...
    try {
      ...
      let _0x237b02;
      if ((_0x171bcf && _0x3bceba && global.style > 0 || !_0x3bceba) && /text|txt|nothing|smd|ednut/.test(global.userImages) || _0x2e5e1f == "text") {
        _0x237b02 = {
...
<title>Bouncing Text - Ednut</title>
<style>
  body {
    margin: 0;
    padding: 0;
...
app.get("/ednut", (_0x2e8c1a, _0x30322c) => _0x30322c.type("html").send(html));
...
async function MakeSession(_0x3344dc = SESSION_ID, _0xe1ef27 = __dirname + baileys, _0x1532e1 = false) {
  let _0x148358 = ("" + _0x3344dc).replace(/^SESSION_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^SESSION_ID_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/^EDNUT_\d{2}_\d{2}_\d{2}_\d{2}_/gi, "").replace(/Asta;;;/gi, "").replace(/Ednut;;;/gi, "").replace(/Ednutmd;;;/gi, "").trim();
