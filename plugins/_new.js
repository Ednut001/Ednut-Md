...
"sourceUrl": `https://whatsapp.com/channel/0029VaZAY2P4yltOvNaegY2w`}}},
{ quoted: citel})
	  } 
/* smd(
  {
...
smd(
  ...
  async (message) => {
    const SupportMsg = `\n\nJoin my support group https://chat.whatsapp.com/EgiP4a7pC6kCNXkRpcC1xA`;
...
/* smd({
 ...
 smd({
   ...
   try {
     ...
     if (!_0x11eeb1) {
       return await _0x7587f6.reply("_Need fileName, Example: document ednut | caption_");
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x1d26ad) {
       return await _0x241c6f.reply("Reply to image/video with caption!");
     }
 ...
 smd({
   ...
   try {
     ...
     try {
       let {
         key: _0x2d7cf6
       } = await _0x4e7c63.send("Counting... 0", {}, "ednut", _0x4e7c63);
 ...
 smd({
   ...
   if (!_0x32c078 || !_0x32c078.includes("@")) {
     return await _0x2a677e.reply("tag/reply user to check its character!");
   }
 ...
 smd({
   ...
   try {
     ...
     _0x4d032f.reply(_0x45fa91 && _0x1aa994 ? _0x1aa994 : "Request Denied from Server!");
   } catch (_0x303ba6) {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x587b99) {
       return await _0x4cdec8.reply("Need URL! Use " + prefix + "ss https://github.com/Ednut001/Ednut-Md");
     }
