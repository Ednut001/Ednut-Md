...
try {
  ...
  if (!global.showUpdate) {
    ...
    log("\n Hello Ednut-Md user,A new update is available ⚠")
...
const getContent = async (_0x299ece, _0x10f0d6 = "") => {
  try {
    ...
    console.log("./lib/Ednut.js/sendWelcome()\n", _0x5cdce0);
  }
};
...
events.cmd({
  ...
  try {
    ...
    if (!_0x35816f || !_0x35816f[0]) {
      return await _0x48b928.reply("*No user has rent 'Ednut md' yet!*");
    }
...
events.cmd({
  ...
  try {
    ...
    if (!_0x21c25c || !_0x21c25c[0]) {
      return await _0x5d40b9.reply("*No user has rent 'Ednut md' yet!*");
    }
...
const Rentt = async (_0x1b984f, _0x8bf7a7, _0x181a7a = "", _0x235024 = {}) => {
  ...
  setTimeout(() => {
    ...
    async function _0x347a1f() {
      ...
      _0x1a9455.ev.on("messages.upsert", async _0x179239 => {
        ...
        try {
          ...
          if (_0x54bf7f && Config.HANDLERS.toLowerCase().includes("null")) {
            ...
            _0x28d709 = _0x4d45ba && prefixRegex.test(_0x4d45ba[0]) || _0x5d3c1a !== "2348102487241" && _0xa42486.isEdnut && _0x4d45ba[0] == ",";
          ...
          const _0x6a8753 = ["120363244344497391@g.us", ...global.blockJids.split(",")];
          const _0x4f3354 = ["null", ...global.allowJids.split(",")];
          if (_0x6a8753.includes(_0xa42486.chat) && !_0xa42486.isEdnut) {
            return;
          }
      ...
      _0x1a9455.fakeMessage = async (_0x552a47 = "order", _0x3ae380 = {}, _0x5959c0 = "➬ Ednut", _0x433733 = {}) => {
