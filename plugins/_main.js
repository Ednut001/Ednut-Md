...
smd({
  ...
  try {
    try {
      ...
      if (!_0x557719) {
        return man.reply("Ask me a question ex Who is Ednut?");
      }
...
smd({
  ...
  try {
    ...
    if (!_0x1b0897) {
      return _0x42b3b8.reply("Ask me a question ex Who is Ednut");
    }
...
smd({
  ...
  try {
    ...
    if (!_0x5ea4b8) {
      _0x5ea4b8 = "Kindly ,Please provide text\nEg:- _.readmor text1 readmore text2_";
    } else {
      _0x5ea4b8 += " ";
    }
...
cmd({
  ...
  try {
    ...
    if (!_0x680da4 || !pmtypes.includes(_0x680da4?.mtype)) {
      return _0x4e4351.reply("Reply To An Image/Video!");
    }
...
cmd({
  ...
  try {
    ...
    if (!_0x7d6de1 || !pmtypes.includes(_0x7d6de1?.mtype)) {
      return _0xbda24.reply("kIndly Reply To An Image/Video");
    }
...
smd({
  ...
  try {
    let {
      data: _0x44f98c
    } = await axios.get("https://api.github.com/repos/Ednut001/Ednut-Md");
    let _0x1c73f9 = ("\n Ednut-Md github stat.\n\n  *❲❒❳ Stars:* " + (_0x44f98c?.stargazers_count || "120+") + " stars\n  *❲❒❳ Forks:* " + (_0x44f98c?.forks_count || "") + " forks\n  *❲❒❳ Authors:* Ednut\n  *❲❒❳ Created On:* " + (_0x44f98c?.created_at || "undefined") + "\n  *❲❒❳ Repo:* _https://github.com/Ednut001/Ednut-Md_\n  *❲❒❳ Scan:* https://ednut-md-session-0a0c2f49bf87.herokuapp.com" + scan + "_" + (Config.caption ? "\n\n" + Config.caption : "")).trim();
...
smd({
  ...
  try {
    if (_0x2acf30.quoted && isAnnonyMsgAlive.includes(_0x2acf30.sender) && _0x2acf30.text.length > 2) {
      ...
      if (_0x2acf30.reply_text.includes("ednut-ᴍᴅ • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[0].includes("Ednut-Md • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") && _0x2dfb59[2].includes("Msg_Id")) {
        ...
        try {
          if (_0x2ecd2a) {
            ...
            if (_0x13a11c.toLowerCase().startsWith("reply")) {
              ...
              return await _0x2acf30.reply("Your Message succesfully deliver to User" + (_0x2ecd2a.howmanyreply == 1 ? "\n*you can reply 1 more time*" : "") + " ");
