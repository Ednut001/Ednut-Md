...
/* smd(
     ...
     try {
       ...
       if (!_0x1c586e) {
         return await _0x1ae8f8.reply(
           "*Provide Repo Url, _.gitclone https://github.com/Ednut001/Ednut-Md_*"
         );
       }
       const _0x5906ab =
 ...
 smd({
   ...
   try {
     ...
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Hi,I am Ednut-Md whatsapp bot._*");
     }
     try {
...
/* smd(
 ...
 smd({
   ...
   try {
     ...
     if (!_0x25d045) {
       return _0x54463e.reply("*" + prefix + "play My way hot kid*");
     }
...
/* smd({ pattern: "threads", category: "downloader", filename: __filename, desc: "Download media from Threads." }, async (m, text) => {
 ...
 smd({
   ...
   try {
     ...
     try {
       ...
       let _0x4b47c3 = "./temp/Ednut-Md " + _0x1d542b[1] + ".mp3";
 ...
 cmd({
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     } else if (_0x5b8ee5[0].includes("Ednut-Md • ʏᴏᴜᴛᴜʙᴇ ᴅᴏᴡɴʟᴏᴀᴅ")) {
