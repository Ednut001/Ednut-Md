const {
 ...
 smd(
  ...
  async (m, username) => {
    try {
      if (!username) {
        return await m.send("Please provide an Instagram username!");
      }
      ...
      if (data.status !== 200) {
        return await m.send("error occurred while fetching the data.");
      }
...
smd(
  ...
  async (m, channelName) => {
    try {
      if (!channelName) {
        return await m.send("kindly provide a YouTube channel name!");
      }
...
smd(
  ...
  async (m, username) => {
    try {
      if (!username) {
        return await m.send("kindly provide a GitHub username");
      }
      ...
      if (data.status !== 200) {
        return await m.send("An error occurred while fetching the data");
      }
...
smd(
  ...
  async (m, ipAddress) => {
    try {
      if (!ipAddress) {
        return await m.send("kindly provide an IP address!");
      }
...
`;
 ...
 smd(
   ...
   async (m, url) => {
     try {
       if (!url) {
         return await m.send("kindly provide a URL!");
       }
       ...
       if (!result || !result.medias || !result.medias.length) {
         return await m.send("No media found");
       }
 ...
 smd({
   ...
   try {
     if (!url) {
       return await m.send("kindly provide a Google Drive URL!");
     }
   ...
   async (message, input) => {
     try {
       ...
       if (!url || !isValidUrl(url)) {
         return await message.send("Please provide a valid Spotify URL");
       }
       ...
       if (!data || data.status !== 200) {
         return await message.reply("couldn't download the Spotify song.");
       }
       ...
       await message.error(
         error + "\n\nCommand: spotify2",
         error,
         "Couldn't download the Spotify song."
       );
     }
   }
 );
 ...
 smd(
   ...
   async (message, input) => {
     try {
       ...
       if (!query) {
         return await message.send("kindly provide a search query.");
       }
     ...
     try {
       ...
       if (!query || !query.startsWith("https://")) {
         return await message.send(
           "kindly provide a valid Twitter Video URL.\nEg: " +
             prefix +
             "tw https://twitter.com/username/status/Ednutll"
         );
       }
 ...
 smd({
   ...
   try {
     if (!_0x155c01) {
       return await _0x19df48.reply("Enter a tg sticker url\nEg: .tgs https://t.me/addstickers/Oldboyfinal\nfrequent usage might lead to ban");
     }
     if (!_0x155c01.includes("addstickers")) {
       return await _0x19df48.reply("kindly Enter a Valid tg sticker url\nEg: .tgs https://t.me/addstickers/Oldboyfinal");
     }
     ...
     for (_0x33784b; _0x33784b < _0x26c3a3; _0x33784b++) {
       ...
       if (_0x3a6ece) {
         ...
         await _0x19df48.bot.sendMessage(_0x19df48.chat, {
           ...
           caption: "Telegram Sticker At Index " + (_0x33784b + 1) + " Downloaded"
         });
       }
     }
   } catch (_0x5a840a) {
     await _0x19df48.error(_0x5a840a + "\n\ncommand: tgs", _0x5a840a, "Error Sending telegram stickers!");
   }
 });
 smd(
   {
   ...
   async (message, input) => {
     try {
       ...
       if (!query || !query.startsWith("https://")) {
         return await message.send(
           'kindly provide a valid Facebook Video URL'
         );
       }
       let video = await astroJson(
 ...
 smd({
   ...
   try {
     ...
     if (!url) {
       return await m.send("kindly provide an Instagram URL");
     }
     ...
     const caption = `*Watermark:* ${wm}\n\n_Note: This media may have a watermark.`;
     ...
     try {
       ...
       for (let i = startIndex - 1; i < endIndex; i++) {
         ...
         if (isSticker) {
           ...
           await message.reply(
             sticker,
             { packname: Config.packname, author: "Ednut-Md" },
             "sticker"
           );
         } else {
           await message.bot.sendMessage(message.chat, {
             image: { url: fileUrl },
             caption: `Telegram Sticker At Index ${i + 1} Downloaded`,
           });
         }
       }
     } catch (error) {
       await message.error(
         `${error}\n\ncommand: tgs`,
         error,
         "Error Sending telegram stickers!"
       );
     }
   }
 );
 smd(
   ...
   async (message, url) => {
     try {
       if (!url) {
         return await message.reply("kindly provide a Snack video URL.");
       }
       ...
       console.error(error);
       await message.reply("error occurred while downloading the video.");
     }
   }
 );
 smd(
   ...
   async (m, query) => {
     try {
       if (!query) {
         return await m.send("kindly Give me search query!");
       }
     ...
     try {
       ...
       if (!query || !query.startsWith("https://")) {
         return await message.send(
           "kindly provide a valid Facebook Video URL.\nEg: " +
             prefix +
             "fb https://www.facebook.com/watch/?v=2018727118289093"
         );
       }
       let video = await astroJson(
         "https://api-smd.onrender.com/api/fbdown?url=" + query
 ...
 smd({
   ...
   try {
     if (!_0x4af114) {
       return _0x7b09ff.reply("Kindly state an App Name");
     }
     ...
     if (_0x468cc8.length) {
       ...
       return _0x7b09ff.reply("Apk not found, Try another name!!");
     }
     const _0x48bc12 = parseInt(_0x538b40.size);
     if (_0x48bc12 > 200) {
       return _0x7b09ff.reply("❌ File size bigger than download capacity");
     }
     ...
     axios.get(_0x31321c, {
       ...
       ;
       _0x7b09ff.reply("Apk not Found");
     });
   } catch (_0x4540ef) {
     await _0x7b09ff.error(_0x4540ef + "\n\ncommand: apk", _0x4540ef, "*Apk not Found!");
   }
 });
 cmd({
   pattern: "apks",
   ...
   try {
     if (!_0x1cb962) {
       return await _0x19d516.reply("kindly, give me app name!");
     }
     ...
     if (_0x4ac8f2.length) {
       ...
       return _0x19d516.reply("APP not Found, Try Other Name");
     }
   } catch (_0xa7fd60) {
     ...
     try {
       ...
       if (!response || response.status !== 200) {
         return await msg.reply(
           "error occurred while downloading the SoundCloud audio"
         );
       }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x25d045) {
       return _0x54463e.reply("*" + prefix + "play intention");
     }
     ...
     if (_0x6845ab && _0x6845ab.duration >= videotime) {
       return await _0x54463e.reply("Can't download, file duration too big");
     }
     ...
     if (_0x37323e) {
       ...
       _0x54463e.send("Video not Found");
     }
     try {
 ...
 smd({
   ...
   try {
     ...
     if (_0x19c223.toString() == "NaN" || _0x19c223 < 1 || _0x19c223 > 160) {
       return _0x2ee3dd.reply("❌ Give a number between 1 to 160");
     }
     ...
     let _0x4737bb = {
       audio: _0x2ba501,
       fileName: "Ednut-Md tiktok Sound" + _0x19c223 + ".m4a",
       mimetype: "audio/mpeg",
       ptt: true,
   ...
   async (message, url) => {
     try {
       ...
       if (!/tiktok/.test(tiktokUrl)) {
         return await message.reply(
           "kindly, Give me Valid Tiktok Video Url!"
         );
       }
   ...
   async (m, query) => {
     try {
       ...
       if (!results || !results.length) {
         return await m.send("No Result found!");
       }
       ...
       return m.reply("kindly, Give me a Name. Ex .pintrest apple");
     }
   }
 );
 smd(
   ...
   async (m, url) => {
     try {
       if (!url || !url.includes("mediafire.com")) {
         return m.reply(
           `Provide mediafire url, Use: ${prefix}mf https://www.mediafire.com/file/i33wo2xvgvid05m/muezzaverse_2221749531_musicaldown.com.mp4/file!`
         );
       }
       ...
       if (!result || !result.link) {
         return m.reply("could not find the file!");
       }
       ...
       m.error(`${e}\n\ncommand: mediafire`, e, "file not found!!");
     }
   }
 );
 smd({
   ...
   try {
     ...
     return _0x2c2023.error(_0x86b411 + "\n\ncommand: mediafire", _0x86b411, "File not found!!");
   }
 });
 cmd({
   pattern: "yts",
 ...
 smd({
   ...
   if (!_0x2d4f04 || !_0x4a3f32[0]) {
     return await _0x1d4717.reply("provide youtube video url!");
   }
   try {
     ...
     try {
       ...
       if (_0x588c42) {
         ...
         await _0x1d4717.send("Video not Found");
       }
       try {
       ...
       return _0x1d4717.error(_0x363775 + "\n\ncommand: ytmp4", _0x363775, " dear, Video not Found!");
     }
   }
 });
 smd({ pattern: "threads", category: "downloader", filename: __filename, desc: "Download media from Threads." }, async (m, text) => {
   try {
     ...
     await m.error(error + "\n\ncommand: threads", error, "No responce from API, Sorry!!");
   }
 });
 smd({ pattern: "instagram", category: "downloader", filename: __filename, desc: "Download Instagram media." }, async (m, text) => {
   try {
     ...
     await m.error(error + "\n\ncommand: instagram", error, "No responce from API, Sorry!");
   }
 });
 smd({
   pattern: "ytmp3",
   ...
   if (!_0x4fe91c || !_0x2758ec[0]) {
     return await _0x3f8930.reply("kindly please, Provide youtube video url!");
   }
   try {
     ...
     try {
       ...
       if (_0x5b9011) {
         ...
         await _0x3f8930.send("audio not Found!");
       }
       try {
         fs.unlinkSync(_0x5b9011);
       } catch {}
     } catch (_0x2cd979) {
       await _0x3f8930.error(_0x2cd979 + "\n\ncommand: ytmp3", _0x2cd979, "dear, audio file not Found!");
     }
   }
 });
 smd({
   ...
   try {
     ...
     try {
       ...
       try {
         ...
         return await _0x17c662.error(_0x4122cc + "\n\ncommand: ytdoc", _0x4122cc, "file not Found!");
       }
     }
     if (!_0x59bbaa) {
       return await _0x17c662.send(" dear, video not found");
     }
     var _0x10e2fa = {
     ...
     await _0x17c662.error(_0xbed50 + "\n\ncommand: ytdoc", _0xbed50, "audio file not Found!");
   }
 });
 cmd({
   on: "text"
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     if (_0x5b8ee5[0].includes("Ednut-Md • sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ")) {
     ...
     } else if (_0x5b8ee5[0].includes("Ednut-Md yt download")) {
     ...
     } else if (_0x5b8ee5[0].includes("Ednut-md • ᴀᴘᴋ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪsᴛ")) {
       ...
       if (_0x205a5f) {
         try {
           ...
           _0xb75e78.reply("can't Download, App Limit Exceed");
         }
       }
     }
   }
