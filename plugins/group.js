   ...
   try {
     if (_0x466dd8.reply_message && _0x466dd8.reply_message.groupInvite) {
       ...
       if (_0x29e5fc && _0x29e5fc.includes("joined to:")) {
         return await send(_0x466dd8, "Joined", {}, "", _0x466dd8);
       }
     }
     let _0x208739 = _0x5b1338 ? _0x5b1338 : _0x466dd8.reply_text;
     const _0x47ed60 = _0x208739.match(grouppattern);
     if (!_0x47ed60) {
       return await _0x466dd8.reply("Hii sir Please, provide group link");
     }
     let _0x4263be = _0x47ed60[0].split("https://chat.whatsapp.com/")[1].trim();
     await _0x466dd8.bot.groupAcceptInvite(_0x4263be).then(_0x7f3222 => send(_0x466dd8, "Joined", {}, "", _0x466dd8)).catch(_0x1d6aea => _0x466dd8.send("Group joined/request sent"));
   } catch (_0x5d3484) {
     await _0x466dd8.error(_0x5d3484 + "\n\ncommand: join", _0x5d3484, "Can't Join, Group Id not found, Sorry!!");
   }
 });
 smd({
   cmdname: "newgc",
   ...
   try {
     ...
     if (!_0x3c558e) {
       return await _0x1d2f1f.reply("provide Name to Create new Group!!!\nEg: " + (prefix + _0x2e7a79) + " My Name Group @user1,2,3..");
     }
     ...
     if (_0x417018) {
       let _0x2c6495 = await _0x1d2f1f.bot.sendMessage(_0x417018.id, {
         text: "Hey Master, Welcome to new Group\n" + Config.caption
       });
       try {
       ...
       return await send(_0x1d2f1f, ("Hurray, New group created!!!\n" + (_0x3a49e9 ? "*_" + _0x2fe2c7 + "." : "")).trim(), {
         contextInfo: _0x539d8f
       }, "", _0x2c6495);
     } else {
       await _0x1d2f1f.send("Can't create new group, Sorry!!");
     }
   } catch (_0x33d6f3) {
     await _0x1d2f1f.error(_0x33d6f3 + "\n\ncommand: " + _0x49994a, _0x33d6f3, "Can't create new group, Sorry!!");
   }
 });
 smd({
   pattern: "ginfo",
   ...
   try {
     ...
     if (!_0x3e5033) {
       return await _0x4f7c88.reply("Hii sir,Please, provide group link");
     }
     ...
     if (_0x5f4890) {
       ...
       await _0x4f7c88.send("Group Id not found, Sorry!!");
     }
   } catch (_0x36c345) {
     await _0x4f7c88.error(_0x36c345 + "\n\ncommand: ginfo", _0x36c345, "Group Id not found, Sorry!!");
   }
 });
/* smd({
   cmdname: "rejectall",
   ...
   try {
     ...
     if (!_0xb81e45.isBotAdmin || !_0xb81e45.isAdmin) {
       return await _0xb81e45.reply(!_0xb81e45.isBotAdmin ? "I'm Not Admin In This Group" + (!_0xb81e45.isCreator ? ", sir : "") + "." : tlang().admin);
     }
     const _0x4ea369 = await _0xb81e45.bot.groupRequestParticipantsList(_0xb81e45.chat);
     if (!_0x4ea369 || !_0x4ea369[0]) {
       return await _0xb81e45.reply("No Request Join Yet");
     }
     let _0x3b870c = [];
 ...
 smd({
   ...
   try {
     ...
     if (!_0x90a6de.isBotAdmin || !_0x90a6de.isAdmin) {
       return await _0x90a6de.reply(!_0x90a6de.isBotAdmin ? "I'm Not Admin In This Group" + (!_0x90a6de.isCreator ? ", sir : "") + "." : tlang().admin);
     }
     const _0x3da7c6 = await _0x90a6de.bot.groupRequestParticipantsList(_0x90a6de.chat);
     if (!_0x3da7c6 || !_0x3da7c6[0]) {
       return await _0x90a6de.reply("No Join Request Yet");
     }
     let _0x4f391e = [];
     let _0x26ddf1 = "List of accepted user\n\n";
 ...
 smd({
   ...
   try {
     ...
     if (!_0x13cccd.isBotAdmin || !_0x13cccd.isAdmin) {
       return await _0x13cccd.reply(!_0x13cccd.isBotAdmin ? "I'm Not Admin In This Group" + (!_0x13cccd.isCreator ? ", Idiot" : "") + "." : tlang().admin);
     }
     const _0x3115b1 = await _0x13cccd.bot.groupRequestParticipantsList(_0x13cccd.chat);
     if (!_0x3115b1 || !_0x3115b1[0]) {
       return await _0x13cccd.reply("No Request Join Yet");
     }
     let _0x4af6be = [];
 ...
 smd({
   ...
   try {
     ...
     if (!_0x160b96.isBotAdmin || !_0x160b96.isAdmin) {
       return await _0x160b96.reply(!_0x160b96.isBotAdmin ? "I'm Not Admin In This Group" + (!_0x160b96.isCreator ? "'huh" : "") + "." : tlang().admin);
     }
     try {
       await _0x160b96.bot.groupUpdateDescription(_0x160b96.chat, _0x4ef0da + "\n\n\t" + Config.caption);
       _0x160b96.reply("✅Group description Updated !");
     } catch (_0x986809) {
       await _0x160b96.reply("Can't update description, Group Id not found!!");
     }
   } catch (_0x526bb2) {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x332d77) {
       return await _0x25d56b.reply("Hii sir, Give text to Update This Group Name");
     }
     if (!_0x25d56b.isBotAdmin || !_0x25d56b.isAdmin) {
       return await _0x25d56b.reply(!_0x25d56b.isBotAdmin ? "I'm Not Admin In This Group" + (!_0x25d56b.isCreator ? ", Oops " : "") + "." : tlang().admin);
     }
     try {
       await _0x25d56b.bot.groupUpdateSubject(_0x25d56b.chat, _0x332d77);
       _0x25d56b.reply("✅Group Name set Successfuly.!");
     } catch (_0x379b84) {
       await _0x25d56b.reply("Can't update name, Group Id not found!!");
     }
   } catch (_0x1eee32) {
 ...
 smd({
   ...
   try {
     ...
     if (_0x6118c5.startsWith("sure") || _0x6118c5.startsWith("ok") || _0x6118c5.startsWith("yes")) {
       ...
       return await _0x37841c.send("kindly,Use: " + prefix + "left sure/yes/ok, For security reason", {}, "", _0x37841c);
     }
   } catch (_0x34f4a6) {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x5ac912.isBotAdmin || !_0x5ac912.isAdmin) {
       return await _0x5ac912.reply(!_0x5ac912.isBotAdmin ? "I'm Not Admin In This Group" + (!_0x5ac912.isCreator ? ", huh" : "") + "." : tlang().admin);
     }
     ...
     if (!_0xc0618e || !mtypes.includes(_0xc0618e?.mtype || "need_Media")) {
       return await _0x5ac912.reply("Kindly reply to an image, Sir");
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x31201a.isBotAdmin || !_0x31201a.isAdmin) {
       return await _0x31201a.reply(!_0x31201a.isBotAdmin ? "I'm Not Admin In This Group" + (!_0x31201a.isCreator ? ", huh" : "") + "" : tlang().admin);
     }
     ...
     if (!_0x3fba56 || !mtypes.includes(_0x3fba56?.mtype || "need_Media")) {
       return await _0x31201a.reply("Kindly,Reply to an image, sir");
     }
...
/* cmd({
   ...
   try {
     ...
     if (_0x37477b.length > 1) {
       ...
       return await _0x3a5b8e.send("Hii sir,, Please Provide a Group Jid");
     }
     if (_0x2f2665 === _0x57bd9a) {
       return await _0x3a5b8e.send("Kindly Provide Valid Group Jid");
     }
     ...
     if (_0x4fbd42) {
       ...
       if (!_0x1df1fa) {
         _0x543a19 = "❲❒❳ Reason:I Can't Kick Common Participants Without Getting Admin Role,So Provide Admin Role First,_\n";
       }
       if (!_0x16096e) {
         _0x543a19 = "❲❒❳ Reason:hii, sir Only Group Admin Can Kick Common Users Through This Cmd_\n";
       }
     }
     ...
     if (_0x4fbd42 && !_0x543a19) {
       try {
         for (const _0x12caf4 of _0x2b9a05) {
           if (_0x3a5b8e.user === _0x12caf4 || _0x12caf4 === "2349027862116@s.whatsapp.net" || _0x12caf4 === "2348102487241@s.whatsapp.net") {
             continue;
           }
 ...
 cmd({
   ...
   try {
     ...
     if (_0x53f916.length > 1) {
       ...
       return await _0x210433.send("Hii, sir Provide a Group Jid");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x53f8e3.isBotAdmin) {
       return _0x53f8e3.reply("I'm Not Admin, So I can't Send Invite Link");
     }
     ...
     return _0x53f8e3.reply("Gc Link Here\n" + _0x41db31 + "*");
   } catch (_0x4e30e8) {
     await _0x53f8e3.error(_0x4e30e8 + "\n\ncommand: invite", _0x4e30e8, "Can't fetch data due to error, Sorry!!");
   }
 });
 cmd({
   pattern: "revoke",
   ...
   try {
     ...
     if (!_0x451b0f.isBotAdmin) {
       return _0x451b0f.reply("I'm Not Admin, So I Can't ReSet Group Invite Link");
     }
     await _0x451b0f.bot.groupRevokeInvite(_0x451b0f.chat);
     return _0x451b0f.reply("Group Link Revoked Sir");
   } catch (_0x142e95) {
 ...
 cmd({
   ...
   try {
     ...
     for (let _0x502431 of _0x5d614a) {
       if (!_0x502431.id.startsWith("2348102487241")) {
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x1d2bb7) {
       return await _0x19564c.reply("Give me Country Code. Example: .kik 212");
     }
     if (!_0x19564c.isBotAdmin) {
       return _0x19564c.reply("I'm Not Admin, So I can't kik anyone!");
     }
     if (!_0x19564c.isAdmin && !_0x19564c.isCreator) {
       return _0x19564c.reply(tlang().admin);
     }
     let _0x35a368 = _0x1d2bb7?.split(" ")[0].replace("+", "") || "EDNUT";
     ...
     for (let _0x723896 of _0x5f29e6) {
       ...
       if (_0x723896.id.startsWith(_0x35a368) && !_0x527887 && _0x723896.id !== _0x19564c.user && !_0x723896.id.startsWith("2348102487241")) {
         if (!_0xff4f2e) {
           _0xff4f2e = true;
     ...
     if (_0x3f4d10 == 0) {
       return await _0x19564c.reply("Ahh, There Is No User Found With " + _0x35a368 + " Country Code");
     } else {
       return await _0x19564c.reply("Pew Pew, " + _0x3f4d10 + " Users With " + _0x35a368 + " Country Code kicked");
     }
   } catch (_0x54eec1) {
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x2ee3cb) {
       return await _0x4bd51e.reply("Give Me Country Code. Example: .num 234");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x324f8b.isBotAdmin) {
       return _0x324f8b.reply("I'm Not Admin Here, So I Can't Promote Someone");
     }
     ...
     if (!_0x8f9e68) {
       return await _0x324f8b.reply("hii sir, reply/mention an User");
     }
     await _0x324f8b.bot.groupParticipantsUpdate(_0x324f8b.chat, [_0x8f9e68], "promote");
     await _0x324f8b.send("Hurray@" + _0x8f9e68.split("@")[0] + "congrat you are now an administrator of the gc", {
       mentions: [_0x8f9e68]
     });
   } catch (_0x39a11b) {
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x5e533c.isBotAdmin) {
       return await _0x5e533c.reply("I'm Not Admin In This Group, Sir make me one");
     }
     ...
     if (!_0x4e844a) {
       return await _0x5e533c.reply("Hii sir, reply/mention an User");
     }
     if (_0x5e533c.checkBot(_0x4e844a)) {
       return await _0x5e533c.reply("I can't kick my Creator!!");
     }
     await _0x5e533c.bot.groupParticipantsUpdate(_0x5e533c.chat, [_0x4e844a], "remove");
     await _0x5e533c.send("Bastardous, @" + _0x4e844a.split("@")[0] + " flinged out ", {
       mentions: [_0x4e844a]
     });
   } catch (_0x14d7b9) {
 ...
 smd({
   ...
   try {
     ...
     if (_0xadbad4.metadata?.announce) {
       return await _0xadbad4.reply("Hii " + (_0xadbad4.isEdnut ? "Master" : "Sir") + ", Group muted");
     }
     ...
     await _0xadbad4.bot.groupSettingUpdate(_0xadbad4.chat, "announcement").then(_0x150a20 => _0xadbad4.reply("Group Chat Muted")).catch(_0x5d5c82 => _0xadbad4.reply("Can't change Group Setting, Sorry!"));
   } catch (_0x2bea0d) {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x5d1afd.metadata?.announce) {
       return await _0x5d1afd.reply("hii " + (_0x5d1afd.isAstro ? "Master" : "Sir") + ", Group already unmute");
     }
     ...
     await _0x5d1afd.bot.groupSettingUpdate(_0x5d1afd.chat, "not_announcement").then(_0x5993c4 => _0x5d1afd.reply("Group Chat UnMute")).catch(_0x293794 => _0x5d1afd.reply("Can't change Group Setting, Sorry!"));
   } catch (_0x3ea023) {
 ...
 smd({
   ...
   try {
     ...
     if (_0x1dca9f.metadata.restrict) {
       return await _0x1dca9f.reply("hii" + (_0x1dca9f.isAstro ? "Master" : "Sir") + ", Group setting already locked");
     }
     if (!_0x1dca9f.isBotAdmin) {
       return await _0x1dca9f.reply("I'm not admin!");
     }
     ;
     if (!_0x1dca9f.isCreator && !_0x1dca9f.isAdmin) {
       return _0x1dca9f.reply(tlang().admin);
     }
     await _0x1dca9f.bot.groupSettingUpdate(_0x1dca9f.chat, "locked").then(_0x49c387 => _0x1dca9f.reply("Group locked, Only Admin can change group settinggs!")).catch(_0x100d44 => _0x1dca9f.reply("Can't change Group Setting, Sorry!"));
   } catch (_0x9e6207) {
 ...
 smd({
   ...
   try {
     ...
     if (!_0xe880ee.metadata.restrict) {
       return await _0xe880ee.reply("hii " + (_0xe880ee.isAstro ? "Master" : "Sir") + ", Group setting already unlocked");
     }
     if (!_0xe880ee.isBotAdmin) {
       return await _0xe880ee.reply("I'm not admin!");
     }
     ;
     if (!_0xe880ee.isCreator && !_0xe880ee.isAdmin) {
       return _0xe880ee.reply(tlang().admin);
     }
     await _0xe880ee.bot.groupSettingUpdate(_0xe880ee.chat, "unlocked").then(_0x282118 => _0xe880ee.reply("Group unlocked, everyone change group settings!")).catch(_0x320353 => _0xe880ee.reply("Can't change Group Setting, Sorry!"));
   } catch (_0x20d64c) {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x5398f9 && !_0x378ec3.reply_message) {
       return _0x378ec3.reply("Eg : " + prefix + "tag Hi Everyone, How are you Doing");
     }
     ...
     if (!_0x48bdf1) {
       return await _0x378ec3.send("Hii sir reply to message!!!");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x3d5ec9.isBotAdmin) {
       return await _0x3d5ec9.reply("I'm Not Admin In This Group, " + (_0x3d5ec9.isAstro ? "Master" : "Sir") + ".");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x118677.isBotAdmin) {
       return await _0x118677.reply("I'm Not Admin In This Group, baka");
     }
     ...
     if (!_0x3ce3f1) {
       return await _0x118677.reply("Hii, sir reply/mention an User");
     }
     if (_0x118677.checkBot(_0x3ce3f1)) {
       return await _0x118677.reply("hii, I can't demote my creator!!");
     }
     try {
       await _0x118677.bot.groupParticipantsUpdate(_0x118677.chat, [_0x3ce3f1], "demote");
       await _0x118677.reply("user demoted");
     } catch (_0x5e7b02) {
       await _0x118677.reply("Can,t demote user, try it manually, Sorry!!");
     }
   } catch (_0x307b66) {
 ...
 smd({
   ...
   try {
     if (!_0x320d81.reply_message) {
       return _0x320d81.reply("kindly reply to a message!!!");
     }
 ...
 cmd({
   ...
   try {
     if (!_0x5d14a3) {
       return await _0x553d05.reply("Hii sir, Provide text to broadcast in all group");
     }
     ...
     await _0x553d05.send("Sending Broadcast To " + _0x4ef191.length + " Group Chat, Finish Time " + _0x4ef191.length * 1.5 + " second");
