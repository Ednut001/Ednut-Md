 ...
 smd({
   ...
   try {
     ...
     if (!_0x160b96.isBotAdmin || !_0x160b96.isAdmin) {
       return await _0x160b96.reply(!_0x160b96.isBotAdmin ? "*_I'm Not Admin In This Group" + (!_0x160b96.isCreator ? "'huh" : "") + "_*" : tlang().admin);
     }
     try {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x5ac912.isBotAdmin || !_0x5ac912.isAdmin) {
       return await _0x5ac912.reply(!_0x5ac912.isBotAdmin ? "*_I'm Not Admin In This Group" + (!_0x5ac912.isCreator ? ", huh" : "") + "_*" : tlang().admin);
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x31201a.isBotAdmin || !_0x31201a.isAdmin) {
       return await _0x31201a.reply(!_0x31201a.isBotAdmin ? "*_I'm Not Admin In This Group" + (!_0x31201a.isCreator ? ", huh" : "") + "_*" : tlang().admin);
     }
...
/* cmd({
 ...
 cmd({
   ...
   try {
     ...
     return _0x53f8e3.reply("*HERE GOES THE GC LINK* \n*" + _0x41db31 + "*");
   } catch (_0x4e30e8) {
 ...
 cmd({
   ...
   try {
     ...
     await _0x324f8b.send("*_@" + _0x8f9e68.split("@")[0] + "congrat you are now an administrator of the gc", {
       mentions: [_0x8f9e68]
     });
   } catch (_0x39a11b) {
 ...
 smd({
   ...
   try {
     ...
     if (_0xadbad4.metadata?.announce) {
       return await _0xadbad4.reply("*Uhh " + (_0xadbad4.isEdnut ? "Master" : "Sir") + ", Group muted*");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x118677.isBotAdmin) {
       return await _0x118677.reply("*_I'm Not Admin In This Group, baka_*");
     }
