...
smd({
  ...
  examples: ["guesscountry london", "guesscountry spain"]
}, async (message, input) => {
  const name = input;
  if (!name) {
...
smd({
  ...
  try {
    ...
    if (!_0x44b37a) {
      Ednut_patch_numGuess[_0x131859] = new GuessingGame();
    }
    _0x44b37a = Ednut_patch_numGuess[_0x131859];
...
smd({
  ...
  let _0x3c3320 = Ednut_patch_hcg[_0x4cf9b7];
  if (_0x3c3320) {
  ...
  try {
    ...
    if (_0x2e9c6b && _0x2e9c6b.id === _0x5d0144 && _0x2e9c6b.player === _0x16aecb.sender && _0x2e9c6b.preAns !== _0x16aecb.text) {
      ...
      if (_0x16aecb.text.toLowerCase() === _0x2e9c6b.capital.toLowerCase()) {
        ...
        delete Ednut_patch_Capital[_0x16aecb.sender];
        try {
          if (global.isMongodb) {
...
smd({
  ...
  if (_0x5aaad7) {
    ...
    if (_0x3fbb59 && isMongodb) {
      await eco.give(_0x303e73.sender, "Ednut", 2000);
    }
