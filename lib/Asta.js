...
yt.download = async (_0x1ea0cb, _0x5c75ae = {
  ...
  try {
    ...
    let _0x3991fc = _0x150898 + "/Ednut-Md " + _0x1ea0cb + "." + _0x35b4d2;
...
setMention.check = async (_0x373988, _0x3c756b = "", _0xde3e80 = false) => {
  try {
    const _0x313fc4 = _0xde3e80 || _0x373988.mentionedJid.includes(_0x373988.user) || _0x3c756b.includes("@" + _0x373988.user.split("@")[0]) || global.mentionasta && (_0x373988.mentionedJid.includes("@2349028622713@s.whatsapp.net") || _0x373988.mentionedJid.includes("@2347080968564@s.whatsapp.net") || /@2347080968564|@2349028622713/g.test(_0x3c756b));
    if (_0x313fc4) {
      if (global.AstroOfficial !== "yes") {
        return;
      }
